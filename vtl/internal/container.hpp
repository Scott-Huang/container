...
#include <vtl/internal/c.hpp>

#define USE_INTERNAL_MEMORY false
...
#define CONTAINER_USE_STL_STRINGVIEW (__cplusplus >= 201703L && (CONTAINER_USE_STL || false))
#define CONTAINER_USE_STL_STRING (CONTAINER_USE_STL || false)
#define CONTAINER_USE_STL_SPAN (__cplusplus >= 202002L && (CONTAINER_USE_STL || true))
